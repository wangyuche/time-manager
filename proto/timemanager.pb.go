...
func (x *RouteSummary) Reset() {
	*x = RouteSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_timemanager_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RouteSummary) Descriptor() ([]byte, []int) {
	return file_timemanager_proto_rawDescGZIP(), []int{4}
}
...
var file_timemanager_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_timemanager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_timemanager_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
